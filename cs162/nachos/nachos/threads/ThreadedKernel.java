...
public class ThreadedKernel extends Kernel {
    ...
    public void selfTest() {
        ...
        PriorityScheduler.selfTestMJ(); // MJ
        PriorityScheduler.selfTestSG(); // SG

        //AW
        Communicator.selfTest();

        Condition2.selfTest(); // RS

        // sup sup
        Boat.selfTest();

        // Alarm tests take a long time (about 10^8 clock ticks).
        // You may want to place your tests before these.
        Alarm.selfTest(); // RS
    }
