...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Expected Collision %:\t" + table.expectedCollisionRate());
    System.out.println("True Collision %:\t" + table.trueCollisionRate());
    System.out.println("Unused Bucket %:\t" + table.unusedBucketRate());
  }
