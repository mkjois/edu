...
public class SocketServer {
    ...
    /**
     * Construct a SocketServer with a ServerSocket listening on an available port.
     */
     ...
     * If the specified port is 0, the ServerSocket should be bound to an
    ...
    public void connect() throws IOException {
        try {
            ...
            this.port = this.server.getLocalPort(); // if auto-allocated
        } catch (NullPointerException e) {
            throw e;
        } catch (Exception e) {
            throw new IOException(ERROR_COULD_NOT_CREATE_SOCKET, e);
        }
    }
    ...
    public void start() throws IOException {
        while (!stopped) {
        	...
        	throw new IOException(ERROR_COULD_NOT_CONNECT, e);
            }
            if (stopped) break;
