                               CS 61B Project 2
                              Network (The Game)
                      Due 5:30 pm Friday, April 5, 2013
                   Interface design due in lab March 12-13
...
==================
Design the classes, modules, and interfaces (see "Teamwork").      March 11
Have working code for the easier modules.                          March 17
Have working code for identifying a network; progress on search.   March 24
Finish project.                                                    April 5
...
have the code that identifies networks implemented by March 24, I advise you
...
Teamwork (10% of project grade) (show to your TA in Lab 7, March 12-13)
========
...
(March 12-13).  Your Lab 7 score depends on having a finished draft of your
...
Every combination of "machine", "human", and "random" works.  It's particularly
amusing to pit two random players against each other.
...
encapsulation.
  ...
  3)  There are no asymptotic limits on running time.  However, part of your
      ...
      of two on a Soda lab machine, we will scrutinize your submission for
  ...
  - All class, method, field, and variable names should be meaningful to a
    human reader.  (Single-letter loop variables whose meanings are obvious are
    okay.)
...
reflect your final code.  Don't forget that it's worth 10% of your grade.
