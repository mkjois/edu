...
class VertexPair {
  ...
  /**
   * VertexPair (Object, Object)
   *
   * Constructs a new VertexPair object that associates the 2 given objects,
   * almost like an edge in a graph.
   *
   ...
   * hashCode () -- int
   *
   * Returns a hash code equal to the sum of the hashCodes of each
   ...
   *
   * @return This VertexPair's hash code.
   */
  public int hashCode () {
    if (this.object1.equals(this.object2)) {
      return this.object1.hashCode() + 1;
    } else {
   ...
   *
   * Returns true if this VertexPair represents the same unordered
  ...
  public boolean equals (Object o) {
    if (o instanceof VertexPair) {
      return ((this.object1.equals(((VertexPair) o).object1)) &&
              (this.object2.equals(((VertexPair) o).object2))) ||
             ((this.object1.equals(((VertexPair) o).object2)) &&
              (this.object2.equals(((VertexPair) o).object1)));
    } else {
      return false;
    }
  }
