...
public class DList implements Iterable<Object> {
  ...
  public void append (DList other) {
      ...
      this.lastIndex += other.lastIndex + 1;
      other.head = new DListNode(null, null, null);
  ...
  /**
   * remove(Object)
   * Removes the given Object from this DList, or does nothing if the Object
   * is not found.
   *
  ...
  /**
   * allPairs()
   * Generates a DList of Object[2]'s that contain all possible pairings of
   * any two Objects in this DList.
   *
   * @return The DList of all combinations of 2.
   */
  public DList allPairs () {
      DList pairs = new DList();
      for (int i = 0; i < this.lastIndex; i++) {
          for (int j = i+1; j < this.lastIndex+1; j++) {
